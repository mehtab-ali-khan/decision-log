...
- Install react-router-dom, react-hot-toast, lucide-react, tailwindcss
- Folder structure: `src/{pages,components,hooks,api,types,theme}`
- Tailwind wired to a single theme config using the design tokens in `README.md` / `AGENTS.md` (primary `#2450E0`, neutral grays, system font stack, `6px` radius)
